...
def train(netC, optimizerC, schedulerC, netG, optimizerG, schedulerG, netF, train_dl, train_dl2, mask, pattern, tf_writer, epoch, opt):
    ...
    for batch_idx, batch1, batch2 in zip(range(l), train_dl, train_dl2):
        ...
        progress_bar(batch_idx, len(train_dl), 'CE Loss: {:.4f} | L2 Loss: {:.6f} | F Loss: {:.6f} | Clean Acc: {:.4f} | Bd Acc: {:.4f} | Cross Acc: {:.4f} | F Acc: {:.4f}'.format(avg_loss_ce, avg_loss_l2,
                                                                                                            # avg_loss_grad_l2,
                                                                                                            avg_loss_F,
                                                                                                            avg_acc_clean,
                                                                                                            avg_acc_bd,
...
def eval(netC, optimizerC, schedulerC, netG, optimizerG, schedulerG, netF, test_dl, test_dl2, mask, pattern, best_clean_acc, best_bd_acc, best_cross_acc, best_F_acc, tf_writer, epoch, opt):
    ...
    for batch_idx, batch1, batch2 in zip(range(l), test_dl, test_dl2):
        with torch.no_grad():
            ...
            acc_F = total_F_correct * 100. / total_sample
...
def main():
    ...
    for epoch in range(epoch_current, opt.n_iters):
        ...
        best_clean_acc, best_bd_acc, best_cross_acc, best_F_acc = eval(netC,
                                            optimizerC, 
                                            schedulerC, 
                                            netG,
                                            optimizerG, 
                                            ...
                                            pattern, 
                                            best_clean_acc,
                                            best_bd_acc, best_cross_acc, best_F_acc, tf_writer, epoch, opt)

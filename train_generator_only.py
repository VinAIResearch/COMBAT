...
def get_model(opt):
    ...
    return netC, netG, optimizerG, schedulerG, netF


def train(netC, netG, optimizerG, schedulerG, netF, train_dl, tf_writer, epoch, opt):
...
def eval(netC, netG, optimizerG, schedulerG, netF, test_dl, best_clean_acc, best_bd_acc, best_F_acc, tf_writer, epoch, opt):
    print(" Eval:")
    netC.eval()
    ...
    # Save checkpoint
    if acc_bd > best_bd_acc:
        print(" Saving...")
        best_clean_acc = acc_clean
        best_bd_acc = acc_bd
        best_F_acc = acc_F
        state_dict = {"netG": netG.state_dict(), "schedulerG": schedulerG.state_dict(), "optimizerG": optimizerG.state_dict(), "best_clean_acc": acc_clean, "best_bd_acc": acc_bd, "best_F_acc": acc_F, "epoch_current": epoch}
...
def main():
    ...
    # prepare model
    netC, netG, optimizerG, schedulerG, netF = get_model(opt)
    ...
    for epoch in range(epoch_current, opt.n_iters):
        ...
        train(netC, netG, optimizerG, schedulerG, netF, train_dl, tf_writer, epoch, opt)
        best_clean_acc, best_bd_acc, best_F_acc = eval(netC, netG, optimizerG, schedulerG, netF, test_dl, best_clean_acc, best_bd_acc, best_F_acc, tf_writer, epoch, opt)

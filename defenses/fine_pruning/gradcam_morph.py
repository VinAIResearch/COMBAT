...
def show_cam_on_image(img, mask, idx, opt):
    ...
    cv2.imwrite(os.path.join(opt.dataset, "bd{}.png".format(idx)), np.uint8(img))
    cv2.imwrite(os.path.join(opt.dataset, "cam{}.png".format(idx)), np.uint8(255 * cam))

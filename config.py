...
def get_arguments():
    ...
    parser.add_argument("--schedulerC_milestones",
                        type=list, default=[100, 150])
    parser.add_argument("--schedulerG_milestones",
                        type=list, default=[100, 150])
    parser.add_argument("--scheduler_clean_milestones",
                        type=list, default=[100, 150])
    ...
    parser.add_argument("--ratio", type=float, default=0.65,
                        help="scale ratio for DCT of noise")
    parser.add_argument("--kernel_size", type=int, default=3,
                        help="kernel size for Gaussian blur")
    parser.add_argument("--sigma", type=tuple, default=(0.1,
                        1.0), help="sigma for Gaussian blur")
    ...
    parser.add_argument("--F_checkpoints", type=str,
                        default="./defenses/frequency_based/checkpoints")
    ...
    parser.add_argument("--clean_model_weight", type=float,
                        default=0.8)  # weight of clean model loss

    parser.add_argument("--noise_only", action="store_true", default=False)
    parser.add_argument("--post_transform_option", type=str,
                        default="use", choices=["use", "no_use", "use_modified"])
